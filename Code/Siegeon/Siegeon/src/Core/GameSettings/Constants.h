...
{
	inline const char* DEFAULT_PATH_TO_SETTINGS = "resources/settings.json";
	...
	inline const char* DEFAULT_RESOLUTION = "1280x720";
	inline const sf::Vector2i DEFAULT_RESOLUTION_INT = sf::Vector2i(1280, 720);

	inline const char* DEFAULT_FONT_NAME = "Orbitron-Medium";
	...
	inline const char* POSSIBLE_WINDOWED_RESOLUTIONS[] =
	{
